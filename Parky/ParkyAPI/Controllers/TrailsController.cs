...
namespace ParkyAPI.Controllers
{
    ...
    public class TrailsController : ControllerBase
        ...
        public IActionResult DeleteTrail(int trailId)
        {
            ...
            var trailkObj = _trailRepository.GetTrail(trailId);
            if (!_trailRepository.DeleteTrail(trailkObj))
            {
                ModelState.AddModelError("", $"Something went wrong when deleting the record {trailkObj.Name}");
                return StatusCode(500, ModelState);
            }
