...
namespace QuotesApi.Controllers
{
    ...
    public class QuotesController : ControllerBase
    {
        ...
        public IActionResult Delete(int id)
        {
            ...
            if(quote == null)
            {
                return NotFound("You can't delete this record");
            }
        ...
        [HttpGet("[action]")]
        public IActionResult PagingQoute(int? pageNumber,int? pageSize)
        {
        ...
        [HttpGet]
        [Route("[action]")]
        public IActionResult SearchQoute(string type)
        {
