...
namespace QuotesApi
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<QuotesDbContext>(option =>option.UseSqlServer(Configuration.GetConnectionString("QuotesConnection")));
            ...
            {
                options.Authority = "https://dev-ec0yth2c.auth0.com/";
